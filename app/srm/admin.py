...
class SupplierAdmin(admin.ModelAdmin):
    list_display = ('name', 'reliability_score', 'credit_score', 'cost_delivery_score','overall_score')  # Fields to display in list view
    search_fields = ('name',)  # Add search capability
    list_filter = ('reliability_score',)  # Add filters
    ordering = ('name',)  # Default ordering

    readonly_fields = ('overall_score','credit_score','reliability_score','cost_delivery_score')
