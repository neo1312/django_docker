...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('srm', '0001_initial'),
        ('inventory', '0006_alter_product_price_alter_product_quantity'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inventory_items', to='inventory.productvariant')),
                ('supplier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='srm.supplier')),
            ],
            options={
